export default function AcknowledgementOfCountry() {
  return (
    <section className="relative z-10 py-[clamp(48px,8vw,96px)] px-[clamp(16px,4vw,48px)] max-w-[800px] mx-auto text-center">
      <h2 className="font-[family-name:var(--font-display)] font-normal text-[clamp(24px,3.5vw,40px)] leading-tight tracking-[-0.02em] m-0 mb-6 text-[var(--ink)]">
